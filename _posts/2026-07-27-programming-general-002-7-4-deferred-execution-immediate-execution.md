---
title: "7-4. 지연 실행(Deferred Execution)과 즉시 실행(Immediate Execution)"
excerpt: "7-4. 지연 실행(Deferred Execution)과 즉시 실행(Immediate Execution) 내용을 정리한다."
categories:
  - Programming
tags:
  - General
...
이번 글에서는 두 방식의 차이와 각각 언제 사용되는지 알아보자.
