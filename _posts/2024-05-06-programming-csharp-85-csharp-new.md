...
<pre class="arduino" style="background-color: var(--bc-code-bg); color: var(--bc-code-text); text-align: start"><code>public class MyClass
{
...
<pre class="csharp" style="background-color: var(--bc-code-bg); color: var(--bc-code-text); text-align: start"><code>MyClass myObject = new MyClass();</code></pre>
...
<pre class="csharp" style="background-color: var(--bc-code-bg); color: var(--bc-code-text); text-align: start"><code>public class MyClass
{
    public int Number { get; set; }
    // 기본 생성자 형태
    public Number(){}
